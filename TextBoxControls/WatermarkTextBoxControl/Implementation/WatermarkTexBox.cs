...
using RimeControls;
using RimeControls.TextBoxControls.AutoSelectTextBoxControl.Implementation;

namespace RimeControls.TextBoxControls.WatermarkTextboxControl.Implementation
{
