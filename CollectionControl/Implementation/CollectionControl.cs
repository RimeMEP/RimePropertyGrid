...
namespace RimeControls.CollectionControl.Implementation
{
    ...
    public class CollectionControl : Control
    {
        ...
        private RimePropertyGrid _propertyGrid;
        ...
        public override void OnApplyTemplate()
        {
            ...
            _propertyGrid = GetTemplateChild(PART_PropertyGrid) as PropertyGrid.RimePropertyGrid;
            if (_propertyGrid != null)
            {
                _propertyGrid.PropertyValueChanged += this.PropertyGrid_PropertyValueChanged;
            }
        ...
        public PropertyGrid.RimePropertyGrid PropertyGrid
        {
            get
            {
                if (_propertyGrid == null)
        ...
        public delegate void ItemDeletingRoutedEventHandler(object sender, Implementation.ItemDeletingEventArgs e);
