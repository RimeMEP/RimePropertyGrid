...
using RimeControls.NumericUpDownControl.Implementation;
            ...
            else
            {
                ...
                if (listType != null)
                {
                    if (!listType.IsPrimitive && !listType.Equals(typeof(String)) && !listType.IsEnum)
                        editor = new RimeControls.PropertyGrid.Implementation.Editors.CollectionEditor();
                    else
                        editor = new RimeControls.PropertyGrid.Implementation.Editors.PrimitiveTypeCollectionEditor();
                }
                else
                {
