...
namespace RimeControls.PropertyGrid.Implementation
{
    internal abstract class ContainerHelperBase
    {
        ...
        public virtual void PrepareChildrenPropertyItem(PropertyItemBase propertyItem, object item)
        {
            ...
            RimePropertyGrid.RaisePreparePropertyItemEvent((UIElement)PropertyContainer, propertyItem, item);
        }
        ...
        public virtual void ClearChildrenPropertyItem(PropertyItemBase propertyItem, object item)
        {
            ...
            RimePropertyGrid.RaiseClearPropertyItemEvent((UIElement)PropertyContainer, propertyItem, item);
        }
